...
```sh
source /usr/share/zsh/plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh at the end of .zshrc
source /usr/share/zsh/plugins/zsh-history-substring-search/zsh-history-substring-search.zsh after the zsh-syntax-highlighting
source /usr/share/zsh/plugins/zsh-autosuggestions/zsh-autosuggestions.zsh
ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE='fg=black,bold'
yay -S fzf
source /usr/share/oh-my-zsh/plugins/zsh-interactive-cd/zsh-interactive-cd.plugin.zsh
```

Powerline font for Windows terminal: CascadiaCodePL

## Files

`.nanorc` (clone of `/etc/nanorc` in `git` on windows):
...
# ZSH_THEME_RANDOM_CANDIDATES=( "fox" "candy" "af-magic" )
...
# Enable 256 colors for current terminal (Windows Terminal)
# TODO: maybe isn't unneeded/must be replaced with, e.g., wterm on wayland session
...
# Enable autosuggestions and set visual style (Requires 256 colors)
source /usr/share/zsh/plugins/zsh-autosuggestions/zsh-autosuggestions.zsh
ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE='fg=244'

# Enable interactive-cd plugin
source /usr/share/oh-my-zsh/plugins/zsh-interactive-cd/zsh-interactive-cd.plugin.zsh
