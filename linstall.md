...
```sh
cd ~/.config
rm -rf alacritty/ anyrun/ dunst/ flameshot/ foot/ frogminer/ gallery-dl/ gtk-3.0/ gtk-4.0/ hypr/ imgvwr/ imv/ kickoff/ kitty/ Kvantum/ lapce-stable/ lsd/ menus/ mpv/ nano/ neofetch/ oculante/ oh-my-posh/ onagre/ Proton/ qimgv/ qt5ct/ qt6ct/ rofi/ steamtinkerlaunch/ swaylock/ tofi/ VSCodium/ waybar/ wleave/ wlogout/ xdg-desktop-portal/ xsettingsd/ yay/ zed/ zsh/ ashell.yml baloofilerc dolphinrc electron-flags.conf electron20-flags.conf electron21-flags.conf electron22-flags.conf electron23-flags.conf electron24-flags.conf electron25-flags.conf electron26-flags.conf electron27-flags.conf electron28-flags.conf kcminputrc kdeglobals plasmarc user-dirs.dirs nushell/oh-my-posh.nu
```
...
# media
paru -S mpv anime4k-git phonon-qt6-mpv oculante libvips obs-studio

# office
paru -S libreoffice-fresh

# downloaders
paru -S yt-dlp gallery-dl
...
# other
paru -S proton-vpn-gtk-app thorium-browser-bin ventoy qbittorrent rustdesk-bin
...
paru -Rns phonon-qt6-vlc kf5 cachyos-themes-sddm flatpak-kcm cachyos-zsh-config octopi
```
...
That's everything, I guess, but better check yerself via vscode
...
## `Apparmor` and `systemd-boot` configurations

See: <https://wiki.cachyos.org/configuration/post_install_setup/>
See `~/downloads/software-and-services/dotfiles/boot/README.md`
